...
// Sensor(nomenclature, is_analog, is_connected, is_low_power, pin_read, pin_power, pin_trigger=-1)
  sensor_ptrs[0] = new rawAnalog("TC", IS_ANALOG, IS_CONNECTED, low_power_status, (uint8_t) DHTPIN, (uint8_t) 9);
  sensor_ptrs[1] = new rawAnalog("BPM", IS_ANALOG, IS_CONNECTED, low_power_status, (uint8_t) PulseWire, (uint8_t) 8);
  //sensor_ptrs[2] = new rawAnalog("SM3", IS_ANALOG, IS_CONNECTED, low_power_status, (uint8_t) A2, (uint8_t) 7);

  sensor_ptrs[0]->set_n_sample(1);
  sensor_ptrs[1]->set_n_sample(1);   
